...
def update_Q(episode, Q,returns_sum, N, gamma=1.0,alpha = 1.0):
...
def td_1_predict(env, num_episodes, gamma=1.0):
    ...
    for i_episode in range(1, num_episodes+1):
        ...
        update_Q(episode, Q, returns_sum, N,0.1)
            
    return Q

#predict the policy values for our test policy
Q = td_1_predict(env, 100000,0.1)
